...
const EC_KEY = "saferide_emergency_contacts_driver";
...
function DriverProfilePage() {
  ...
  const avgRating = ratingSummary?.avgScore ?? driverProfile?.avgRating ?? 0;
  const totalRides = driverProfile?.totalRides ?? BigInt(0);
            ...
            {!isVerified && (
              <div className="bg-amber-500/10 rounded-xl p-3 flex items-start gap-2">
                ...
                <p className="text-xs text-amber-600 dark:text-amber-400 leading-relaxed">
                  Documents are being reviewed. This usually takes up to 24
                  hours.
                </p>
              </div>
            )}
